...
const fileDir = 'content/1st/splatzones';
...
// ブログ記事ページ
const SplatZonesBlogPost = async function ({ params }) {
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="md:flex gap-10 justify-between">
                    <h2 className="text-ikyellow-800 dark:text-ikpurple-100 text-3xl font-bold tracking-tight sm:text-4xl m-0">
                        <img src="/images/1st/smup-area.png" width="1920" height="1080" alt="スーパマンタローカップ ルール ガチエリア" className='w-full sm:w-60 mb-4' />
                        <SplatZonesLogo className="w-60" />
                    </h2>
...
export default SplatZonesBlogPost;